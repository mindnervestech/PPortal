...
-- Dumping data for table patient-portal.appointment: ~0 rows (approximately)
...
INSERT INTO `appointment` (`id`, `appointment_date`, `appointment_month`, `appointment_year`, `appointment_dmy`, `status`, `notes`, `visit_type`, `start_min`, `end_min`, `appointment_of_id`, `appointment_of_type`, `appointment_with_id`, `appointment_with_type`) VALUES
	(1, 11, 5, 2014, '2014-06-11 00:00:00', 'PARTIAL', NULL, 'Urgent', 810, 840, 2, 'User', 2, 'Doctor');
...
-- Dumping data for table patient-portal.associated_symptom: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `body_location` (
  ...
  `gender_type` varchar(255) COLLATE utf8_bin DEFAULT NULL,
  `group_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_body_location_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- Dumping data for table patient-portal.body_location: ~0 rows (approximately)
/*!40000 ALTER TABLE `body_location` DISABLE KEYS */;
INSERT INTO `body_location` (`id`, `name`, `containedin_id`, `gender_type`, `group_id`) VALUES
	(1, 'Ears', NULL, 'BOTH', NULL),
	(2, 'Face', NULL, 'BOTH', NULL),
	(3, 'Eyes', NULL, 'BOTH', NULL),
	(4, 'Head', NULL, 'BOTH', NULL),
	(5, 'Mouth', NULL, 'BOTH', NULL),
	(6, 'Nose', NULL, 'BOTH', NULL),
	(7, 'Scalp', NULL, 'BOTH', NULL),
	(8, 'Fore Head', NULL, 'BOTH', NULL),
	(9, 'Right Eye', NULL, 'BOTH', 3),
	(10, 'Left Eye', NULL, 'BOTH', 3),
	(11, 'Right Ear', NULL, 'BOTH', 1),
	(12, 'Left Ear', NULL, 'BOTH', 1),
	(13, 'Jaws', NULL, 'BOTH', NULL),
	(14, 'Chin', NULL, 'BOTH', NULL),
	(15, 'Right Face', NULL, 'BOTH', 2),
	(16, 'Left Face', NULL, 'BOTH', 2),
	(18, 'Throat', NULL, 'BOTH', NULL),
	(19, 'Neck', NULL, 'BOTH', NULL),
	(20, 'Neck(Front)', NULL, 'BOTH', NULL),
	(21, 'Chest', NULL, 'BOTH', NULL),
	(22, 'Left Chest', NULL, 'MALE', 21),
	(23, 'Right Chest', NULL, 'MALE', 21),
	(24, 'Left Breast', NULL, 'FEMALE', NULL),
	(25, 'Right Breast', NULL, 'FEMALE', NULL);
...
-- Dumping data for table patient-portal.communication: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.country: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.degree_confered: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.doctors: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.education: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.epsdt_services: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.ethnicities: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.gender: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.home_heating: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.languages: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.marital_status: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.occupation: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.occupational_hazards: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.pain_area: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.patient: ~0 rows (approximately)
/*!40000 ALTER TABLE `patient` DISABLE KEYS */;
INSERT INTO `patient` (`id`, `gender`, `firstname`, `lastname`, `patient_id`, `is_temp`, `patient_password`) VALUES
	(1, 'MALE', 'Pankaj', 'Muneshwar', 'P001', 0, 'asd123'),
	(2, 'FEMALE', 'Diksha', 'Dave', 'P002', 0, 'pass');
...
-- Dumping data for table patient-portal.payment_modes: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.prefer_languages: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.races: ~0 rows (approximately)
...
-- Dumping structure for table patient-portal.relations
...
-- Dumping data for table patient-portal.relations: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.relieved_by: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.religion: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.statuses: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.student_status: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.visit_type: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.when_this_happen: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.worsed_by: ~0 rows (approximately)
...
-- Dumping data for table patient-portal.yes_nos: ~0 rows (approximately)
